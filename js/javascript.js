...
function newProject(){
 	url = 'http://ec2-52-34-213-191.us-west-2.compute.amazonaws.com/codeFiddle/codingPage.php';
	...
	$.ajax({
	    ...
	    success: function(result){
	    	...
	    	console.log(result);
	     	...
	     	url = 'http://ec2-52-34-213-191.us-west-2.compute.amazonaws.com/codeFiddle/codingPage.php?projectId=' + projectId + '&branchId=' + branchId + '&commitId=' + commitId;
		 	window.location.href = url;
